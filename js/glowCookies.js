...
class GlowCookies {
    ...
    this.Cookies.innerHTML = `<div 
                                ...
                                >
                                    ...
                                    <div class="btn__section">
                                        <button type="button" id="acceptCookies" class="btn__accept accept__btn__styles mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--yellow mdl-color-text--black" style="color: ${this.banner.acceptBtn.color}; background-color: ${this.banner.acceptBtn.background};">
  ...
  openManageCookies() {
    this.PreBanner.style.display = this.config.hideAfterClick
      ? "none"
      : "block";
